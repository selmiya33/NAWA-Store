                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 form-input form">
                                                            <input type="text" name="customer_lasst_name"
                                                                value="{{ old('customer_lasst_name') }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="select-items">
                                                        <select name="customer_code_country" class="form-control">
                                                            <option value="0">select</option>
                                                            @foreach ($countries as $code => $name)
                                                                <option @selected($code == old('customer_code_country'))
                                                                    value="{{ $code }}">{{ $name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
